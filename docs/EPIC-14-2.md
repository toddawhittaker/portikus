...
| **T6 Docs, rehearsal and pilot** | builder for docs, infra for the rehearsal and pilot | `docs/SPEC.md` (5.1, 5.2, 5.3, 24.11, 29); `docs/EPIC-14.md` (a superseded note per ruling); `docs/adr/0031` (status to built), `0028` and `0023` (status lines); `docs/OPERATIONS.md` (every provider section, "The first administrator" becomes "The local administrator"); `infra/README.md`; `docs/OVERVIEW.md`; `docs/STATUS.md`; `docs/BACKLOG.md` | all others | 1.5 days docs, 1 day rehearsal and pilot |
